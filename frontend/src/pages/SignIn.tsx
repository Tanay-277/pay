			...
			<Card className="w-full max-w-lg">
									...
									<FormItem>
										...
										<FormControl>
											<Input
												...
												{...field}
												className="w-full h-12 cursor-pointer focus:cursor-text"
											/>
										</FormControl>
										<FormMessage>Dummy Email : john@gmail.com</FormMessage>
									</FormItem>
								)}
							/>
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormMessage>Dummy Password : john@123</FormMessage>
									</FormItem>
								)}
							/>
				...
				<CardFooter>
					<p>
						...
						<Link to="/sign-up" className="underline underline-offset-1">
							Create Now
						</Link>
					</p>
				</CardFooter>
